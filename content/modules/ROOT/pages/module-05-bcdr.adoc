...
. Navigate to *Virtualization* -> *VirtualMachines*, click on the three-dot menu to the right of the *fedora02* VM and select *Stop* from the menu that appears (you may need to switch back to the *vmexamples-{user}* project). When the VM is stopped, click on the three-dot menu and select *Delete*.
+
