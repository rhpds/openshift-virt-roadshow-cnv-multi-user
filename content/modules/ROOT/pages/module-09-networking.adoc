...
+
image::2025_spring/module-09-networking/20_UDN_Network_Tile.png[link=self, window=blank, width=100%]

. Switch to the Console tab and login to the VM. 
+
image::2025_spring/module-09-networking/21_UDN_Fedora_Console.png[link=self, window=blank, width=100%]
+
