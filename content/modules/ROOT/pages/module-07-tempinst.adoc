...
. On the menu that pops up, name the new PVC *windows-2k19-sysprep-template*, set the *Access mode* to *Shared access (RWX)* and change the *StorageClass* to *ocs-external-storagecluster-ceph-rbd-immediate*. Lastly, click the *Clone* button.
+
