...
. Navigate back to *Virtualization* persona dropdown, and then click on *VirtualMachines* in the left-side menu. Expand the project *vmexamples-{user}* in the center column and highlight the *fedora01* virtual machine.
+
