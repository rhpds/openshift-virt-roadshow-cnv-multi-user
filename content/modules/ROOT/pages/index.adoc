...
Red Hat® OpenShift Virtualization Engine provides the proven virtualization functionality of Red Hat OpenShift to deploy, manage, and scale virtual machines (VMs). Only pay for what you need with a streamlined solution focused exclusively on VM workloads.
...
image::index/00_openshift_comparison_chart.png[link=self, window=blank, width=100%]
