Thank you for attending {lab_name}!

image::2025_spring/conclusion/00_Thank_You.png[[link=self, window=blank, width=100%]

We hope you have enjoyed learning more about *OpenShift Virtualization* and how it can be a useful tool for both the import and management of legacy virtual machines, as well as a stepping stone on the path of application modernization.
...
+
image::2025_spring/conclusion/01_Ebook.png[[link=self, window=blank, width=100%]
...
Scan the QR code below to learn more:
+
image::2025_spring/conclusion/02_DO317_Training.png[[link=self, window=blank, width=100%]
...
Scan the QR code below to learn more:
+
image::2025_spring/conclusion/03_VMA_QR.png[[link=self, window=blank, width=100%]
