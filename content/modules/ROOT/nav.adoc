...
* xref:module-02-warm-migration.adoc[Advanced Migration Options]
** xref:module-02-warm-migration.adoc#config_hooks[Automated Configuration Hooks]
** xref:module-02-warm-migration.adoc#warm_migration[Warm Migration]
